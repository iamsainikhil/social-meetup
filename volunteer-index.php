...
<h2 style="color:black;">My Profile</h2>
   <div class="regisFrm">
        ...
        <a href="volunteer-update.php">Edit Profile</a><span style=text-align:right">    <a href="volunteer-account.php?logoutSubmit=1" class="logout">Logout</a></span>
    </div>
</div>
<div class="container-large">
<h2 style="color:black;">Events</h2>
<p><iframe src="https://www.jotform.com/grid/71162935706054" frameborder="0" style="width: 100%; height:auto;min-height:200px; border:none;" scrolling="no"></iframe></p><br/>
...
<div class="container">
    <h2 style="text-align:center;color:black;">Login to Your Volunteer Account</h2>
    ...
    <div class="regisFrm">
        ...
        <p>Don't have an account? <a href="volunteer-register.php">Register</a></p>
    </div>
</div>
    <?php } ?>