...
$id = $userData['id'];
  ...
  $sql = "UPDATE organization SET first_name = '$first_name', last_name = '$last_name', email = '$email', phone = '$phone', password = '$password' WHERE id = '$id' ";
...
<p>Click &nbsp;<a href="organization-index.php">here&nbsp;</a> to go back to your Profile page</p>
</div>